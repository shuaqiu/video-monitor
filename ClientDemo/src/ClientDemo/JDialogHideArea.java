...
public class JDialogHideArea extends javax.swing.JDialog {
    ...
    函数描述:   保存遮挡区域设置到结构体
     *************************************************/
    private void jRadioButtonShowAreaActionPerformed(java.awt.event.ActionEvent evt)                                                     
    {                                                         
     ...
     *************************************************/
    private void jRadioButtonSetAreaActionPerformed(java.awt.event.ActionEvent evt)                                                    
    {                                                        
       	if (m_lPlayHandle.intValue() < 0)
		return;

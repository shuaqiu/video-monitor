...
public class JDialogChannelConfig extends javax.swing.JDialog
{
    ...
    函数描述:	保存压缩参数到结构体
     *************************************************/
    private void jButtonCompressOKActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    函数描述:	设置遮盖报警参数
     *************************************************/
    private void jButtonSetHideAreaActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    函数描述:  设置信号丢失报警参数
     *************************************************/
    private void jButtonSetSignalLostActionPerformed(java.awt.event.ActionEvent evt) {                                                     
    ...
    函数描述:	设置移动侦测报警参数
     *************************************************/
    private void jButtonSetMotionActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        int iChannelNumber = -1;
        int iIndex = jComboBoxChannelNumber.getSelectedIndex();
        if((iIndex < m_strDeviceInfo.byChanNum) && (iIndex >=0))
        {
    ...
    函数描述:	设置遮挡报警参数
     *************************************************/
    private void jButtonSetHideAlarmActionPerformed(java.awt.event.ActionEvent evt) {                                                    
          int iChannelNumber = -1;
        int iIndex = jComboBoxChannelNumber.getSelectedIndex();
        if((iIndex < m_strDeviceInfo.byChanNum) && (iIndex >=0))
        {
     ...
     *************************************************/
    private void jButtonStringActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    函数描述:	设置当前通道参数
     *************************************************/
    private void jButtonSetChanConfigActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        int iChannelNumber = -1;
        int iIndex = jComboBoxChannelNumber.getSelectedIndex();
        if((iIndex < m_strDeviceInfo.byChanNum) && (iIndex >=0))
        {
     ...
     *************************************************/
    private void jComboBoxChannelNumberActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        showChannelConfig();
    }                                                      
     ...
     *************************************************/
    private void jComboBoxCompressTypeActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        int iCompressType = jComboBoxCompressType.getSelectedIndex();
        switch (iCompressType)
        {
            case 0:
    ...
    函数描述:   弹出对话框显示和设置录像参数
     *************************************************/
    private void jButtonSetRecordActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    函数描述:   设置按钮enable属性
     *************************************************/
    private void jCheckBoxHideAreaActionPerformed(java.awt.event.ActionEvent evt)                                                  
    {                                                      
    ...
    函数描述:   设置按钮enable属性
     *************************************************/
    private void jCheckBoxMotionActionPerformed(java.awt.event.ActionEvent evt)                                                
    {                                                    
    ...
    函数描述:   设置按钮enable属性
     *************************************************/
    private void jCheckBoxSignalLostActionPerformed(java.awt.event.ActionEvent evt)                                                    
    {                                                        
    ...
    函数描述:   设置按钮enable属性
     *************************************************/
    private void jCheckBoxHideAlarmActionPerformed(java.awt.event.ActionEvent evt)                                                   
    {                                                       

 ...
 */
import ClientDemo.HCNetSDK.NET_DVR_SHOWSTRING_V30;
...
public class JDialogShowString extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        jTextFieldSrtingX.setText("jTextField1");

        jLabel3.setText("Y坐标");

        jTextFieldStringY.setText("jTextField2");

        jLabel4.setText("叠加字符");

        jTextFieldString.setText("jTextField3");
     ...
     *************************************************/
    private void jButtonSetUpActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    函数描述:	显示对应区域的参数
     *************************************************/
    private void jComboBoxShowAreaActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        showStringConfig();
    }                                                 

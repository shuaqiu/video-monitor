...
public class JDialogHideAlarm extends javax.swing.JDialog {
   ...
   /*************************************************
    ...
    函数描述:	开始画框
     *************************************************/
    private void panelPlayMousePressed(java.awt.event.MouseEvent evt)                                       
    {                                           
        if (m_bDrawdetect)
        {
    ...
    函数描述:	画框
     *************************************************/
    private void panelPlayMouseDragged(java.awt.event.MouseEvent evt)                                       
    {                                           
        if (m_bDrawdetect)
        {
            POINT point = new POINT(evt.getX(), evt.getY());
    ...
    函数描述:	显示遮挡框
     *************************************************/
    private void jCheckBoxGetHideAlarmAreaActionPerformed(java.awt.event.ActionEvent evt)                                                          
    {                                                              
    ...
    函数描述:	设置遮挡框
     *************************************************/
    private void jCheckBoxSetHideAlarmAreaActionPerformed(java.awt.event.ActionEvent evt)                                                          
    {                                                              
   	if (m_lPlayHandle.intValue() < 0)
	{
		return;

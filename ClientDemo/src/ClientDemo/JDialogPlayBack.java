 ...
 ****************************************************************************/
 class JDialogPlayBack extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxRecodType.setBounds(70, 30, 110, 21);

        jComboBoxFlieType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "全部", "解锁", "锁定" }));
        jPanel1.add(jComboBoxFlieType);
        jComboBoxFlieType.setBounds(70, 60, 110, 21);

        jLabelStartTime.setText("开始时间");
        jPanel1.add(jLabelStartTime);
        jLabelStartTime.setBounds(10, 210, 60, 50);

        jLabelEndTime.setText("结束时间");
        jPanel1.add(jLabelEndTime);
        jLabelEndTime.setBounds(10, 270, 60, 50);
        jPanel1.add(jTextFieldsYear);
        jTextFieldsYear.setBounds(80, 210, 40, 21);
        jPanel1.add(jTextFieldsMonth);
        jTextFieldsMonth.setBounds(160, 210, 30, 21);
        jPanel1.add(jTextFieldsDay);
        jTextFieldsDay.setBounds(220, 210, 30, 21);
        jPanel1.add(jTextFieldsHour);
        jTextFieldsHour.setBounds(80, 240, 40, 21);
        jPanel1.add(jTextFieldsMinute);
        jTextFieldsMinute.setBounds(160, 240, 30, 21);
        jPanel1.add(jTextFieldsSecond);
        jTextFieldsSecond.setBounds(220, 240, 30, 21);

        jLabel1.setText("年");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(130, 210, 20, 15);

        jLabel2.setText("月");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(200, 210, 20, 15);

        jLabel3.setText("日");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(260, 210, 30, 15);

        jLabel4.setText("时");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(130, 240, 20, 15);

        jLabel5.setText("分");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(200, 240, 20, 15);

        jLabel6.setText("秒");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(260, 240, 30, 15);
        jPanel1.add(jTextFieldeMonth);
        jTextFieldeMonth.setBounds(160, 270, 30, 21);
        jPanel1.add(jTextFieldeDay);
        jTextFieldeDay.setBounds(220, 270, 30, 21);
        jPanel1.add(jTextFieldeHour);
        jTextFieldeHour.setBounds(80, 300, 40, 21);
        jPanel1.add(jTextFieldeMinute);
        jTextFieldeMinute.setBounds(160, 300, 30, 21);
        jPanel1.add(jTextFieldeSecond);
        jTextFieldeSecond.setBounds(220, 300, 30, 21);

        jLabel7.setText("年");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(130, 270, 20, 15);

        jLabel8.setText("月");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(200, 270, 20, 15);

        jLabel9.setText("日");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(260, 270, 30, 15);

        jLabel10.setText("时");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(130, 300, 20, 15);

        jLabel11.setText("分");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(200, 300, 20, 15);

        jLabel12.setText("秒");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(260, 300, 30, 15);
        jPanel1.add(jTextFieldeYear);
        jTextFieldeYear.setBounds(80, 270, 40, 21);

        jRadioButtonByCardNumber.setText("按卡号");
        jPanel1.add(jRadioButtonByCardNumber);
        jRadioButtonByCardNumber.setBounds(10, 130, 90, 23);

        jLabel13.setText("卡号");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(30, 160, 30, 15);

        jTextFieldCardNumber.setText("0");
        jPanel1.add(jTextFieldCardNumber);
        jTextFieldCardNumber.setBounds(70, 160, 200, 21);
        ...
        jTextFieldChannelNumber.setBounds(70, 90, 110, 21);
        ...
        jButtonSearch.setBounds(10, 330, 60, 23);
        ...
        jProgressBar.setBounds(140, 580, 400, 20);

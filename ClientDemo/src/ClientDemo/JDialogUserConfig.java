...
import ClientDemo.HCNetSDK.NET_DVR_USER_V30;
...
public class JDialogUserConfig extends javax.swing.JDialog {
    ...
    {                                                  
     ...
     函数描述:	显示对应的权限参数
      *************************************************/
    private void jComboBoxLocalActionPerformed(java.awt.event.ActionEvent evt)                                               
    {                                                   
        if(bInitialed)
        {
            showLocalChannel();
     ...
     函数描述:	显示对应的权限参数
      *************************************************/
    private void jComboBoxRemoteActionPerformed(java.awt.event.ActionEvent evt)                                                
    {                                                    
      if(bInitialed)
      {
          showRemoteChannel();
     ...
     函数描述:   保存权限类型对应通道参数
      *************************************************/
    private void jButtonSaveLocalActionPerformed(java.awt.event.ActionEvent evt)                                                 
    {                                                     
     ...
     函数描述:   保存权限类型对应通道参数
      *************************************************/
    private void jButtonSaveRemoteActionPerformed(java.awt.event.ActionEvent evt)                                                  
    {                                                      
        m_iUserIndex = jComboBoxUser.getSelectedIndex();
      ...
      *************************************************/
    private void jButtonSaveUserActionPerformed(java.awt.event.ActionEvent evt)                                                
    {                                                    
         m_iUserIndex = jComboBoxUser.getSelectedIndex();

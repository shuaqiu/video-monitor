...
public class JDialogAlarmCfg extends javax.swing.JDialog
{
     ...
     *************************************************/
    private void jButtonComfirmExceptionActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    函数描述:   调用接口设置异常参数
     *************************************************/
    private void jButtonSetupExceptionActionPerformed(java.awt.event.ActionEvent evt) {                                                      
    ...
    函数描述:  显示对应该异常类型的参数
     *************************************************/
    private void jComboBoxExceptionTypeActionPerformed(java.awt.event.ActionEvent evt) {                                                       
    ...
    函数描述:   显示对应报警输入通道的参数
     *************************************************/
    private void jComboBoxAlarmInChannelActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        if (bInitialed)
        {
            showAlarmInCfg();
    ...
    函数描述:   显示对应星期的时间段参数
     *************************************************/
    private void jComboBoxDateActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    函数描述:   选择对应星期的时间段参数
     *************************************************/
    private void jComboBoxPTZChannelActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        if (bInitialed)
        {
    ...
    函数描述:   保存当日的时间段信息至结构体
     *************************************************/
    private void jButtonConfirmInTimeActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        int iWeekDay = jComboBoxDate.getSelectedIndex();
    ...
    函数描述:   保存PTZ配置信息至结构体
     *************************************************/
    private void jButtonPTZConfirmActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        int iPTZChannel = jComboBoxPTZChannel.getSelectedIndex();
    ...
    函数描述:   选择对应星期的时间段参数
     *************************************************/
    private void jComboBoxAlarmOutChannelActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        if (bInitialed)
        {
            showAlarmOutCfg();
    ...
    函数描述:   显示对应星期的时间段参数
     *************************************************/
    private void jComboBoxWeekDayActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    函数描述:   调用接口设置报警输出参数
     *************************************************/
    private void jToggleButtonSetupAlarmOutActionPerformed(java.awt.event.ActionEvent evt) {                                                           
    ...
    函数描述:   调用接口设置报警输入参数
     *************************************************/
    private void jButtonSetupAlarmInActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    函数描述:   销毁对话框
     *************************************************/
    private void jButtonExit2ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        dispose();
    }                                            
    ...
    函数描述:   销毁对话框
     *************************************************/
    private void jButtonExit3ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        dispose();
    }                                            
    ...
    函数描述:   销毁对话框
     *************************************************/
    private void jButtonExit1ActionPerformed(java.awt.event.ActionEvent evt)                                             
    {                                                 
         dispose();
    }                                            

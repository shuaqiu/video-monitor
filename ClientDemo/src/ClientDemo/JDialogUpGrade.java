...
public class JDialogUpGrade extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jProgressBarUpgrade, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jProgressBarUpgrade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    函数描述:	设置网络环境
     *************************************************/
    private void jButtonSetNetEnvirActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    函数描述:	调用接口,开始升级
     *************************************************/
    private void jButtonUpgradeActionPerformed(java.awt.event.ActionEvent evt) {                                               
        ...
        } else
        {
            ...
            {//这个是用来停止此任务的,否则就一直循环执行此任务了
                if (m_lUpgradeHandle == new NativeLong(-1))
                {

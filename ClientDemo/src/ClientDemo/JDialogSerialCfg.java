 ...
 *类描述 ：串口参数配置,串口透传
 ****************************************************************************/
import ClientDemo.HCNetSDK.FSerialDataCallBack;
import ClientDemo.HCNetSDK.NET_DVR_DECODERCFG_V30;
import ClientDemo.HCNetSDK.NET_DVR_DEVICEINFO_V30;
import ClientDemo.HCNetSDK.NET_DVR_PTZCFG;
import ClientDemo.HCNetSDK.NET_DVR_RS232CFG_V30;
...
public class JDialogSerialCfg extends javax.swing.JDialog
{
    ...
    函数描述:	设置232配置参数
     *************************************************/
    private void jButtonSetup232ActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    函数描述:	获取并显示对应通道的参数
     *************************************************/
    private void jComboBox485ChannelActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        if (b485Initialed)
        {
    ...
    函数描述:	设置相应485通道配置参数
     *************************************************/
    private void jButtonSetup485ActionPerformed(java.awt.event.ActionEvent evt) {                                                
        int iChannelNumber = jComboBox485Channel.getSelectedIndex() + m_strDeviceInfo.byStartChan;
    ...
    函数描述:	停止透明通道
     *************************************************/
    private void jButtonDistructActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if (m_lSerialHandle.intValue() != -1)
        {
